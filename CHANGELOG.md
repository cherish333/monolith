...
- **Action counts (live):** v0.17.0 in-tree total lands at **1374 actions across 22 in-tree namespaces** (up from Phase 2's 1369 / 21). Live `monolith_discover()` returns **1597 total across 26 namespaces** with all four host-project sibling plugins loaded (1374 in-tree + 11 `claudedesign` + 158 `inventory` + 28 `steam` + 26 `substance` = 1597). Sibling action counts remain advisory and never affect the public Monolith release headline.
